...
def make_and_solve_qcp_problem(n, alpha):
    model, theta_vars = make_qcp_problem(n, alpha)
    model.optimize()
...
if __name__ == "__main__":
    ...
    print(make_and_solve_qcp_problem(args.n, args.alpha))
