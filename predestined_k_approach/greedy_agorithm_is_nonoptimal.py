...
def main():
    ...
    custom_envelope = bare_forest.fill_boundary_to_envelope([0] * 5 + [1, 2], is_upper=False)
    ...
    greedy_envelope = bare_forest.fill_boundary_to_envelope(greedy_lower_boundary, is_upper=False)
